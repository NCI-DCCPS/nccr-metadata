...
|------|---------|---------|
| [`nccr_vocab.ttl`]({{ site.baseurl }}/nccr_vocab.ttl) | **Vocabulary** — OWL classes and properties for variables, value sets, filters, processing rules, and display configuration | ~120 |
| [`nccr_datmm.ttl`]({{ site.baseurl }}/nccr_datmm.ttl) | **Dataset catalog** — DATMM 6.0.0 metadata describing the platform and all 9 datasources, agents, contributions, and funding | ~180 |
| [`nccr_instances.ttl`]({{ site.baseurl }}/nccr_instances.ttl) | **Instance data** — Complete RDF representation of all 533 variables, 2,303 coded values, 51 cohort filters, and processing rules | 28,620 |
